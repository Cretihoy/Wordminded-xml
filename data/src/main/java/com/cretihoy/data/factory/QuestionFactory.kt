package com.cretihoy.data.factory
...
@Inject constructor() {
    ...
    private fun getLetterList(): List<LetterModel> {
        return listOf(
            LetterModel(
                letter = R.string.letter_01
            ),
            LetterModel(
                letter = R.string.letter_02
            ),
            LetterModel(
                letter = R.string.letter_03
            ),
//            R.string.letter_04,
//            R.string.letter_05,
//            R.string.letter_06,
...
//            R.string.letter_26
    ...
    private fun getTaskList(): List<TaskModel> {
        return listOf(
            TaskModel(
                task = R.string.task_01
            ),
            TaskModel(
                task = R.string.task_02
            ),
            TaskModel(
                task = R.string.task_03
            ),
//            R.string.task_04,
//            R.string.task_05,
//            R.string.task_06,
